...
from training.validation2 import validation,validation_without_calc
...
def test_net(net, args, ema_net=None, fold_idx=0):
    ...
    if args.test_without_calc:
        test_perf = validation_without_calc(net_for_eval, testLoader, args, mode="Testing")
    else:
        test_perf = validation(net_for_eval, testLoader, args, mode='Testing')
...
if __name__ == '__main__':
    ...
    for fold_idx in range(args.k_fold):
        ...
        test_perf = test_net(net, args, ema_net, fold_idx=fold_idx)
